...
report 50100 "FTT Sales Invoice"
{
    //RDLCLayout = 'FTTSalesInvoice.rdl';
    //DefaultLayout = RDLC;
    WordLayout = 'FTTSalesInvoice.docx';
    defaultLayout = Word;
    Caption = 'FTT Sales - Invoice';
        ...
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            */
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(Attributes; Attributes) { } //DAO Added field
